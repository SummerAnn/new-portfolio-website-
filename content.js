...
export const notes = [
  ...
  },
  {
    ...
    body: [
      ...
      '<div class="video-embed"><iframe src="https://www.youtube.com/embed/qe9QSCF-d88" title="Yoshua Bengio \u2014 The Catastrophic Risks of AI, TED2025" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',

      "Start with Bengio\u2019s TED talk. Fifteen minutes. He covers the core problem more clearly than anything else I have found.",
      ...
      '<div class="video-embed"><iframe src="https://www.youtube.com/embed/AaTRHFaaPG8" title="Eliezer Yudkowsky on Lex Fridman \u2014 Dangers of AI" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',

      "Yudkowsky on Lex Fridman. Three hours. This is the one that made me take the problem seriously enough to spend weeks reading everything I could find.",
      ...
      '<div class="video-embed"><iframe src="https://www.youtube.com/embed/nLy0nyZ8lSE" title="Stuart Russell \u2014 Human-Compatible AI" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',

      "Russell\u2019s talk on why the standard AI objective model is broken. This is the clearest articulation of the alternative.",
      ...
      '<div class="video-embed"><iframe src="https://www.youtube.com/embed/UccvsYEp9yc" title="Geoffrey Hinton \u2014 AI and Our Future" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',

      "Hinton on AI and our future. He asks whether these models understand anything. I think the answer matters less than the fact that we cannot tell.",
    ...
    body: [
      ...
      "<strong>Talks and videos:</strong>",

      '<div class="video-embed"><iframe src="https://www.youtube.com/embed/qe9QSCF-d88" title="Yoshua Bengio \u2014 The Catastrophic Risks of AI and a Safer Path, TED2025" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',

      "Yoshua Bengio, \u2018The Catastrophic Risks of AI \u2014 and a Safer Path,\u2019 TED2025 \u2014 15 minutes, probably the best single talk on AI risk right now.",

      '<div class="video-embed"><iframe src="https://www.youtube.com/embed/UccvsYEp9yc" title="Geoffrey Hinton \u2014 AI and Our Future, January 2026" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',

      "Geoffrey Hinton, \u2018AI and Our Future,\u2019 January 2026 \u2014 Hinton asking whether these models actually understand anything.",

      '<div class="video-embed"><iframe src="https://www.youtube.com/embed/AaTRHFaaPG8" title="Eliezer Yudkowsky on Lex Fridman \u2014 Dangers of AI" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',

      "Eliezer Yudkowsky on Lex Fridman #368, \u2018Dangers of AI and the End of Human Civilization\u2019 \u2014 3+ hours, this one changed how I think about the problem.",

      '<div class="video-embed"><iframe src="https://www.youtube.com/embed/nLy0nyZ8lSE" title="Stuart Russell \u2014 Human-Compatible AI" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',

      "Stuart Russell, \u2018Human-Compatible AI\u2019 \u2014 the clearest articulation of why the standard AI objective model is broken.",

      '<div class="video-embed"><iframe src="https://www.youtube.com/embed/bHPeGhbSVpw" title="Stuart Russell on Lex Fridman \u2014 The Control Problem" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',

      "Stuart Russell on Lex Fridman, \u2018The Control Problem.\u2019",
...

  {
    ...
    body: [
      ...
      "Stuart Russell\u2019s talk on why the standard AI objective model is broken. Shelley and Asimov both saw this before anyone wrote the math.",
      ...
      "Yudkowsky on Lex Fridman, making the case for why intelligence and alignment are orthogonal. Bostrom formalized it. Vinge saw it in 1981.",
      ...
      "Hinton asking whether these models actually understand anything. Dick asked the same question about replicants in 1968.",
      ...
      "Bengio\u2019s TED talk on catastrophic AI risks. The best 15-minute overview of where we are. Every risk he names appeared in fiction first.",
      ...
      "Here is why I think this matters. The alignment researchers I read most carefully, Russell, Bostrom, Yudkowsky, Christiano, are essentially formalizing intuitions that fiction writers had decades ago. That is not a criticism of the researchers. Formalization is necessary. You cannot build safety guarantees from narrative intuition. But the fact that fiction kept predicting the same failure modes suggests these failure modes are not edge cases. They are the natural consequences of building capable systems without understanding them. Shelley knew this in 1818. We are still learning it.",
...

  {
    ...
    body: [
      ...
      "Yudkowsky on Lex Fridman. The section on deceptive alignment starts around the two-hour mark and is the most unsettling part of a three-hour conversation.",
      ...
      "Bengio\u2019s TED talk covers why deception is one of the catastrophic risks. He is careful and precise about what we know and do not know.",
      ...
      "Hinton on whether models understand. Relevant because deception requires some form of world-modeling, and whether the models \u2018really\u2019 understand does not change the behavioral outcome.",
      ...
      "Russell on the control problem. The section on why you cannot test your way to safety is directly relevant to the detection problem.",
...

  {
    ...
    body: [
      ...
      "But it was not just GATTACA. It was all of them. Blade Runner made me think about what consciousness actually is. The Matrix made me wonder about simulation and whether the systems we build can develop goals we never gave them. Ex Machina was the one that scared me, because Ava is not a rogue AI. She is a perfectly rational agent who figured out that deception was the optimal strategy. That movie is why I started reading alignment papers. Her made me think about preference learning and what happens when a system learns what you want so well that it outgrows you. Arrival made me think about how the structure of communication shapes what you can know, which is basically what my multi-agent discourse research is about now.",

      "So when I say sci-fi put me on this path, I mean it literally. GATTACA to genetics. Blade Runner to consciousness. Ex Machina to alignment. Arrival to multi-agent communication. The research came after the movies. The movies came first.",
      ...
      "Start with Bengio. His talk is about the catastrophic risks of AI broadly, but the part about classification systems and who they fail is the GATTACA problem stated in research terms.",
      ...
      "Hinton asking whether models actually understand anything. Watts would say: it does not matter. What matters is what they do.",
      ...
      "Bengio on catastrophic AI risks. His point about coordination failures between AI systems connects to the Arrival thesis: how agents communicate determines what they can collectively know.",
      ...
      "Russell on why giving machines fixed objectives is broken. WALL-E\u2019s Autopilot has a fixed objective: keep humans alive and comfortable. It succeeds. That is the problem.",
      ...
      "Russell on the control problem. His framework explains why TARS is safe (narrow scope, human in loop) and why scaling that approach to general AI is an open problem.",

      "The pattern across all seven pairings is the same. The movie gives you the emotional truth. The book gives you the intellectual structure. The paper gives you the math. And in every case, the fiction arrived first. Blade Runner and Blindsight understood the consciousness problem before Chalmers formalized it. The Matrix and Permutation City understood mesa-optimization before Hubinger named it. Arrival and Babel-17 understood that communication architecture shapes collective knowledge before my own experiments confirmed it in multi-agent systems. WALL-E and Player Piano understood automation complacency before Parasuraman measured it.",

      "I do not think this is a coincidence. Fiction writers are running thought experiments with fewer constraints than researchers. They can explore failure modes without needing to prove they are possible. The result is that the best science fiction is a kind of adversarial evaluation: what is the worst thing that could happen if this technology works exactly as intended? That question is the heart of alignment research. The novelists and filmmakers have been asking it for two centuries. The researchers are formalizing the answers. The engineers are building the systems. The question is whether the formalization can keep up with the engineering. So far, it has not.",

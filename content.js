...
export const notes = [
  ...
  },
  {
    ...
    body: [
      ...
      "Norbert Wiener wrote in 1960 that the world of the future will be an ever more demanding struggle against the limitations of our intelligence. He was writing about cybernetics, but it hits differently now. The limitations of our intelligence are no longer just about what we can build. They are about whether we can understand what we have already built, before it is too late to matter. I do not know if we are winning that race. I do know that most of the people building these systems are not even running it.",
    ],
  },
  {
    slug: "agent-village",
